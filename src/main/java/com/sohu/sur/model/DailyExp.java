 ...
 */
@Embedded
public class DailyExp  implements Serializable {
    ...
    public static DailyExp create(String actionCode) {
        DailyExp ret = new DailyExp();
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DailyExp == false) {
            return false;
        }
        if (this == obj) {
            return true;
        }
        DailyExp rhs = (DailyExp) obj;
